...
const cli = require('../module/cli');
console.log('p-cli.js line 22',cli);

const readdir = promisify(fs.readdir);
console.log('p-cli.js line 25',readdir);

const registryAddr = process.env.CITIZEN_ADDR || 'http://127.0.0.1:3000';
console.log('p-cli.js line 28',registryAddr);
...
module.exports = async (namespace, type, version, protocols, cmd) => {
  ...
  try {
    ...
    spinner.color = 'yellow';
    spinner.start();
    console.log('p-cli.js line 162',cmd.gpgkeyg);
  ...
  console.log('p-cli.js line 181',providerFullPath);
  try {
    ...
    console.log('p-cli.js line 201',res);
...
console.log('p-cli.js line 207 end');
